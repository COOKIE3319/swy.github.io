				...
				<div class="l10">
					...
					<div class="x12 dn">
						<div class="form-group">
							...
							<div class="field">
								<textarea id="c_mcontent" class="input" name="c_mcontent" row="5" /></textarea>
					...
					<div class="x12 dn">
						<div class="form-group">
							...
							<div class="field">
								<textarea id="c_mscontent" class="input" name="c_mscontent" row="5" /></textarea>
					...
					<div class="x12">
						<div class="form-group">
							...
							<div class="field">
								<textarea id="c_slideshow" class="input" name="c_slideshow" row="5" /></textarea>
							</div>
						</div>
					</div>
					<div class="x12">
					...
					<div class="x2">
						<div class="form-group">
							...
							<div class="field">
								<div class="l10">
									<div class="x6"><input id="c_twidth" class="input" name="c_twidth" type="text" maxlength="255" size="60" value="0" data-validate="required:必须填写,plusinteger:必须为正整数" /></div>
									<div class="x6"><input class="input" name="c_theight" type="text" maxlength="255" size="60" value="0" data-validate="required:必须填写,plusinteger:必须为正整数"/></div>
								</div>
							</div>
						</div>
					</div>
