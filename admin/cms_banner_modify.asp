...
If Not inull(rf("save")) Then
	Set rs = ado_mquery("select * from cms_banner where id = "&rqs("id")&"")
			...
			<form method="post">
				...
				<div class="form-group dn">
					...
					<div class="field">
						...
						<label class="btn"><input name="b_parent" type="radio" value="2" <%=iif((rs("b_parent") = 2),"checked=""checked""","")%>/>手机端</label>
					</div>
				</div>
				<div class="form-group">
