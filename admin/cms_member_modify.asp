...
call non_numeric_back(rqs("id"),"参数不能为空而且必须为数字！")
If rf("submit") = "修改" Then
	m_point = rf("m_point")
    Call non_numeric_back(m_point, "积分不能为空！而且必须为数字！")
	conn.Execute("update cms_member set m_point="&m_point&" where id="&rqs("id")&"")
	...
	<div id="right">
		...
		<div class="bd">
			<table class="table table-bordered table-hover">
				<%Set rs = ado_mquery("select * from cms_member where id = "&rqs("id")&"")%>
				<tr>
					<td width="120">状态</td>
