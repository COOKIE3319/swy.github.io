...
If Not inull(rqs("del")) Then
	Call non_numeric_back(rqs("del"),"参数非法")
	Set rs = ado_query("select * from cms_chip where id = "&rqs("del")&"")
	If rs.EOF Then
	...
	rs.Close
	Set rs = Nothing
	conn.Execute("delete from cms_chip where id = "&rqs("del")&"")
