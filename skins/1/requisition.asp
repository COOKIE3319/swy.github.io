...
<div class="container">
	...
	<form method="post" class="form-big">
		<div class="form-group">
			...
			<div class="field">
				<input id="r_username" class="input" name="r_username" type="text" size="60" data-validate="required:必须填写" value="" />
			</div>
		</div>
		<div class="form-group">
			<div class="label"><label for="r_tel">联系电话</label></div>
			<div class="field">
				<input id="r_tel" class="input" name="r_tel" type="text" size="60" data-validate="required:必须填写" value="" />
			</div>
		</div>
		<div class="form-group">
			<div class="label"><label for="r_email">电子邮件</label></div>
			<div class="field">
				<input id="r_email" class="input" name="r_email" type="text" size="60" data-validate="required:必须填写,email:请填写合法的电子邮件" value="" />
			</div>
		</div>
		<div class="form-group">
			<div class="label"><label for="r_content">情况介绍</label></div>
			<div class="field">
				<textarea id="r_content" class="input" name="r_content" row="5" data-validate="required:必须填写" /></textarea>
			</div>
		</div>
