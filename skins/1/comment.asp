...
<div class="container">
	...
	<div class="l20">
		<div class="x12">
			<div class="quote mb20">
				<h3><a href="<%=i_url(rqs("id"))%>"><%=get_field("cms_info",rqs("id"),"i_name")%></a></h3>
			</div>
		</div>
		<div class="x4">
			...
			<div class="bd1">
				<form method="post" class="form-big">
					...
					<div class="form-group">
						...
						<div class="field">
							<input id="save" class="btn btn-big bg-dot" name="save" type="submit" value="提交评论" />
						</div>
					</div>
				</form>
			</div>
