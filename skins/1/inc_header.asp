<div id="header_menu">
	<div class="container">
		<div class="line">
			<div class="x8">
				<%If site_s1 = 1 Then%><a href="<%=site_murl%>"><span class="icon-mobile"> 手机版</span></a><%End If%>
			...
			<div class="x4 ar">
				...
				<%If site_s10 = 1 Then%><a id="StranLink"><span class="icon-globe"> 繁體中文</span><script language="JavaScript" src="<%=site_dir%>plus/language.js"></script></a><%End If%>
	...
	<div class="container">
		<div class="line">
			...
			<div class="x8">
				<ul id="navigation">
					<%
					Set rs = ado_query("select * from cms_channel where c_nav = 1 and c_parent = 0 order by c_order desc , id asc")
					Do While Not rs.EOF
					%>
